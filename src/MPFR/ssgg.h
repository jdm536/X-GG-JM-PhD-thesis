...
// SS-GG reduction for ZZ_mat<mpz_t> type basis
int ssgg (
                ZZ_mat<mpz_t> &A,
                FP_NR<mpfr_t> delta,
                int d,
